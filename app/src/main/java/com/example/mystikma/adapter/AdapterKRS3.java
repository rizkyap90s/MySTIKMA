...
public class AdapterKRS3 extends RecyclerView.Adapter<AdapterKRS3.MyHolder> {

    FirebaseAuth firebaseAuth = FirebaseAuth.getInstance();
    FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance();
    List<Semester3> model;
    List<TampungKRS> tampungKRS = new ArrayList<>();
    Context con;
    String getNIM, getSMSTR;

    public AdapterKRS3(Context con, List<Semester3> model, String getNIM, String getSMSTR) {
        this.con=con;
        this.model=model;
        this.getNIM=getNIM;
